...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ButtonSprite> : ModifyBase<ModifyDerive<Der, ButtonSprite>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(base::get() + 0x3ed20, Thiscall, ButtonSprite, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3f150, Default, ButtonSprite, create, char const*, int, int, float, bool, char const*, char const*, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3ee40, Default, ButtonSprite, create, cocos2d::CCSprite*, int, int, float, float, bool, char const*, bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3f220, Thiscall, ButtonSprite, init, char const*, int, int, float, bool, char const*, char const*, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3eef0, Thiscall, ButtonSprite, init, cocos2d::CCSprite*, int, int, float, float, bool, char const*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(ButtonSprite, setColor, cocos2d::ccColor3B)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3fae0, Thiscall, ButtonSprite, setString, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3f520, Thiscall, ButtonSprite, updateBGImage, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3f660, Thiscall, ButtonSprite, updateSpriteBGSize, )
