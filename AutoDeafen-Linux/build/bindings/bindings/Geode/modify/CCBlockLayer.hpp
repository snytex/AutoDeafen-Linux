...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CCBlockLayer> : ModifyBase<ModifyDerive<Der, CCBlockLayer>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CCBlockLayer, decrementForcePrio, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CCBlockLayer, incrementForcePrio, )
		}
	};
}
