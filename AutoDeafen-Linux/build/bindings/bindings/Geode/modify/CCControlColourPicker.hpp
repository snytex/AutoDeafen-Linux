...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::extension::CCControlColourPicker> : ModifyBase<ModifyDerive<Der, cocos2d::extension::CCControlColourPicker>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<ccColor3B const&>::func(&cocos2d::extension::CCControlColourPicker::setColorValue)), Thiscall, cocos2d::extension::CCControlColourPicker, setColorValue, ccColor3B const&)
		}
	};
}
