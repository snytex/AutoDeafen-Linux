...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCMenuItemToggle> : ModifyBase<ModifyDerive<Der, cocos2d::CCMenuItemToggle>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*, cocos2d::SEL_MenuHandler, cocos2d::CCMenuItem*>::func(&cocos2d::CCMenuItemToggle::createWithTarget)), Default, cocos2d::CCMenuItemToggle, createWithTarget, cocos2d::CCObject*, cocos2d::SEL_MenuHandler, cocos2d::CCMenuItem*)
