...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCSAXParser> : ModifyBase<ModifyDerive<Der, cocos2d::CCSAXParser>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<void*, cocos2d::CC_XML_CHAR const*, const CC_XML_CHAR **>::func(&cocos2d::CCSAXParser::startElement)), Default, cocos2d::CCSAXParser, startElement, void*, cocos2d::CC_XML_CHAR const*, const CC_XML_CHAR **)
