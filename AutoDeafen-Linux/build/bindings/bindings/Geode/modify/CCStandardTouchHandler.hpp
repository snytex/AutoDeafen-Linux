...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCStandardTouchHandler> : ModifyBase<ModifyDerive<Der, cocos2d::CCStandardTouchHandler>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress((HMODULE)base::getCocos(), "??1CCStandardTouchHandler@cocos2d@@UEAA@XZ")), Thiscall, cocos2d::CCStandardTouchHandler)
