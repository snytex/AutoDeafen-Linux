...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CCURLObject> : ModifyBase<ModifyDerive<Der, CCURLObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1782a0, Default, CCURLObject, create, gd::string, gd::string)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CCURLObject, init, gd::string, gd::string)
		}
	};
}
