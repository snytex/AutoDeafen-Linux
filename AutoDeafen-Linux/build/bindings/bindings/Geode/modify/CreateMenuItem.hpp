...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CreateMenuItem> : ModifyBase<ModifyDerive<Der, CreateMenuItem>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x127700, Default, CreateMenuItem, create, cocos2d::CCNode*, cocos2d::CCNode*, cocos2d::CCObject*, cocos2d::SEL_MenuHandler)
