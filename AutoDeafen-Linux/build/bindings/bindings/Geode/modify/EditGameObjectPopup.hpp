...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, EditGameObjectPopup> : ModifyBase<ModifyDerive<Der, EditGameObjectPopup>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(EditGameObjectPopup, create, EffectGameObject*, cocos2d::CCArray*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2938e0, Thiscall, EditGameObjectPopup, init, EffectGameObject*, cocos2d::CCArray*, bool)
		}
	};
}
