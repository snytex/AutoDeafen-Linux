...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJFollowCommandLayer> : ModifyBase<ModifyDerive<Der, GJFollowCommandLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x268d00, Default, GJFollowCommandLayer, create, EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x26a130, Thiscall, GJFollowCommandLayer, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x26b1a0, Thiscall, GJFollowCommandLayer, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x26a850, Thiscall, GJFollowCommandLayer, textChanged, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x268e30, Thiscall, GJFollowCommandLayer, init, EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x26a790, Thiscall, GJFollowCommandLayer, onUpdateGroupID, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x26a7f0, Thiscall, GJFollowCommandLayer, onUpdateGroupID2, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x26a440, Thiscall, GJFollowCommandLayer, sliderChanged, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x26a5d0, Thiscall, GJFollowCommandLayer, sliderXModChanged, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x26a610, Thiscall, GJFollowCommandLayer, sliderYModChanged, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x26b120, Thiscall, GJFollowCommandLayer, updateDuration, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x26a500, Thiscall, GJFollowCommandLayer, updateDurLabel, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x26ae80, Thiscall, GJFollowCommandLayer, updateTargetGroupID, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x26af50, Thiscall, GJFollowCommandLayer, updateTargetGroupID2, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x26ad60, Thiscall, GJFollowCommandLayer, updateTextInputLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x26adf0, Thiscall, GJFollowCommandLayer, updateTextInputLabel2, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x26b020, Thiscall, GJFollowCommandLayer, updateXMod, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x26a650, Thiscall, GJFollowCommandLayer, updateXModLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x26b0a0, Thiscall, GJFollowCommandLayer, updateYMod, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x26a6f0, Thiscall, GJFollowCommandLayer, updateYModLabel, )
		}
	};
}
