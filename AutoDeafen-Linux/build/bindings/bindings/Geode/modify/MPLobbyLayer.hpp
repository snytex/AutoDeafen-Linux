...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, MPLobbyLayer> : ModifyBase<ModifyDerive<Der, MPLobbyLayer>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MPLobbyLayer, keyDown, cocos2d::enumKeyCodes)
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MPLobbyLayer, keyUp, cocos2d::enumKeyCodes)
