...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, MusicArtistObject> : ModifyBase<ModifyDerive<Der, MusicArtistObject>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MusicArtistObject, create, int, gd::string, gd::string, gd::string)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MusicArtistObject, init, int, gd::string, gd::string, gd::string)
		}
	};
}
