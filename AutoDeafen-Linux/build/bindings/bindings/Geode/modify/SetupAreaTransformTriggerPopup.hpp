...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupAreaTransformTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupAreaTransformTriggerPopup>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(SetupAreaTransformTriggerPopup, create, EnterEffectObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3f6420, Thiscall, SetupAreaTransformTriggerPopup, init, EnterEffectObject*, cocos2d::CCArray*)
		}
	};
}
