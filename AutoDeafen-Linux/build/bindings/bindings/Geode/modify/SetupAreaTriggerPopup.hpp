...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupAreaTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupAreaTriggerPopup>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(SetupAreaTriggerPopup, create, EnterEffectObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3f8c00, Thiscall, SetupAreaTriggerPopup, init, EnterEffectObject*, cocos2d::CCArray*)
		}
	};
}
