...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupCheckpointPopup> : ModifyBase<ModifyDerive<Der, SetupCheckpointPopup>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(SetupCheckpointPopup, create, CheckpointGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x450a20, Thiscall, SetupCheckpointPopup, init, CheckpointGameObject*, cocos2d::CCArray*)
		}
	};
}
