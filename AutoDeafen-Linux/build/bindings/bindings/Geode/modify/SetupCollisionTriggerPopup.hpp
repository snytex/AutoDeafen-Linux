...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupCollisionTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupCollisionTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x400520, Default, SetupCollisionTriggerPopup, create, EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4014d0, Thiscall, SetupCollisionTriggerPopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x402140, Thiscall, SetupCollisionTriggerPopup, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x401ac0, Thiscall, SetupCollisionTriggerPopup, textChanged, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x400660, Thiscall, SetupCollisionTriggerPopup, init, EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x401960, Thiscall, SetupCollisionTriggerPopup, onActivateOnExit, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x401660, Thiscall, SetupCollisionTriggerPopup, onEnableGroup, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4019f0, Thiscall, SetupCollisionTriggerPopup, onItemID2Arrow, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x401a30, Thiscall, SetupCollisionTriggerPopup, onItemIDArrow, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x401a70, Thiscall, SetupCollisionTriggerPopup, onTargetIDArrow, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4016f0, Thiscall, SetupCollisionTriggerPopup, onTargetP1, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4017b0, Thiscall, SetupCollisionTriggerPopup, onTargetP2, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x401870, Thiscall, SetupCollisionTriggerPopup, onTargetPP, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x401f30, Thiscall, SetupCollisionTriggerPopup, updateItemID, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x401fd0, Thiscall, SetupCollisionTriggerPopup, updateItemID2, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x401e10, Thiscall, SetupCollisionTriggerPopup, updateItemID2InputLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x401d40, Thiscall, SetupCollisionTriggerPopup, updateItemIDInputLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x402070, Thiscall, SetupCollisionTriggerPopup, updateTargetID, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x401eb0, Thiscall, SetupCollisionTriggerPopup, updateTargetIDInputLabel, )
		}
	};
}
