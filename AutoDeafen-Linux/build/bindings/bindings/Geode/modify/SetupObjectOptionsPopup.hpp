...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupObjectOptionsPopup> : ModifyBase<ModifyDerive<Der, SetupObjectOptionsPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x250330, Thiscall, SetupObjectOptionsPopup, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x8ba30, Thiscall, SetupObjectOptionsPopup, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e7cd0, Thiscall, SetupObjectOptionsPopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x84620, Thiscall, SetupObjectOptionsPopup, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e62f0, Thiscall, SetupObjectOptionsPopup, init, GameObject*, cocos2d::CCArray*, SetGroupIDLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e8500, Thiscall, SetupObjectOptionsPopup, onAlwaysHide, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e88f0, Thiscall, SetupObjectOptionsPopup, onApplyScaleStick, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e8dd0, Thiscall, SetupObjectOptionsPopup, onCenterEffect, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e83e0, Thiscall, SetupObjectOptionsPopup, onDisableGlow, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e8230, Thiscall, SetupObjectOptionsPopup, onDisableObject, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e8740, Thiscall, SetupObjectOptionsPopup, onDontBoost, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e87d0, Thiscall, SetupObjectOptionsPopup, onDontBoostX, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e8080, Thiscall, SetupObjectOptionsPopup, onDontEnter, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e7ff0, Thiscall, SetupObjectOptionsPopup, onDontFade, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e8b30, Thiscall, SetupObjectOptionsPopup, onExtendedCollision, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e86b0, Thiscall, SetupObjectOptionsPopup, onExtraSticky, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e8350, Thiscall, SetupObjectOptionsPopup, onGripSlope, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e8110, Thiscall, SetupObjectOptionsPopup, onHideEffects, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e8aa0, Thiscall, SetupObjectOptionsPopup, onHighDetail, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e7f60, Thiscall, SetupObjectOptionsPopup, onIceBlock, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e8860, Thiscall, SetupObjectOptionsPopup, onNoAudioScale, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e8590, Thiscall, SetupObjectOptionsPopup, onNonStickX, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e8620, Thiscall, SetupObjectOptionsPopup, onNonStickY, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e81a0, Thiscall, SetupObjectOptionsPopup, onNoParticle, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e8470, Thiscall, SetupObjectOptionsPopup, onPassable, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e8c60, Thiscall, SetupObjectOptionsPopup, onReverse, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e8d20, Thiscall, SetupObjectOptionsPopup, onSinglePlayerTouch, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e8a10, Thiscall, SetupObjectOptionsPopup, onToggleAreaParent, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e8980, Thiscall, SetupObjectOptionsPopup, onToggleGroupParent, cocos2d::CCObject*)
		}
	};
}
