...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ShaderLayer> : ModifyBase<ModifyDerive<Der, ShaderLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x46a890, Thiscall, ShaderLayer, objectPosToShaderPos, cocos2d::CCPoint)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x46d840, Thiscall, ShaderLayer, preChromaticGlitchShader, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x46d0d0, Thiscall, ShaderLayer, preGlitchShader, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x46e380, Thiscall, ShaderLayer, preLensCircleShader, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x46e850, Thiscall, ShaderLayer, preMotionBlurShader, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x46dd70, Thiscall, ShaderLayer, prepareTargetContainer, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(ShaderLayer, prePinchShader, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x46dbc0, Thiscall, ShaderLayer, prePixelateShader, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x46cbc0, Thiscall, ShaderLayer, preShockLineShader, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x46c070, Thiscall, ShaderLayer, preShockWaveShader, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x46f8b0, Thiscall, ShaderLayer, preSplitScreenShader, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x46a6e0, Thiscall, ShaderLayer, setupCommonUniforms, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x46c9c0, Thiscall, ShaderLayer, setupShockLineUniforms, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x46be70, Thiscall, ShaderLayer, setupShockWaveUniforms, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x46f700, Thiscall, ShaderLayer, setupSplitScreenShader, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x46a4f0, Thiscall, ShaderLayer, toggleAntiAlias, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x46eb60, Thiscall, ShaderLayer, triggerBulge, float, float, float, float, float, int, int, float, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x46d520, Thiscall, ShaderLayer, triggerChromaticGlitch, bool, float, float, float, float, float, float, float, int, float, bool, bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x46f430, Thiscall, ShaderLayer, triggerColorChange, float, float, float, float, float, float, float, int, float)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x46f1b0, Thiscall, ShaderLayer, triggerInvertColor, float, float, float, float, float, bool, bool, bool, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x46e0e0, Thiscall, ShaderLayer, triggerLensCircle, float, float, float, float, int, int, float, float, int, float, bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x46ed70, Thiscall, ShaderLayer, triggerPinchX, float, float, float, float, float, bool, int, int, float, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x46ef90, Thiscall, ShaderLayer, triggerPinchY, float, float, float, float, float, bool, int, int, float, bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x46e5b0, Thiscall, ShaderLayer, triggerRadialBlur, float, float, float, float, int, float, float, bool, int, int, float, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(ShaderLayer, triggerSepia, float, float, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x46c510, Thiscall, ShaderLayer, triggerShockLine, float, float, bool, bool, bool, bool, float, float, float, float, float, float, int, bool, bool, bool, float, bool, float, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x46b8b0, Thiscall, ShaderLayer, triggerShockWave, float, float, float, float, float, float, float, bool, float, float, float, int, bool, bool, bool, float, float, bool, float, int, float)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x470f60, Thiscall, ShaderLayer, tweenValue, float, float, int, float, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x470860, Thiscall, ShaderLayer, tweenValueAuto, float, int, float, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x46aa50, Thiscall, ShaderLayer, updateEffectOffsets, cocos2d::CCPoint)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x471070, Thiscall, ShaderLayer, updateZLayer, int, int, bool)
		}
	};
}
