...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, URLViewLayer> : ModifyBase<ModifyDerive<Der, URLViewLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x29d3b0, Default, URLViewLayer, create, gd::string, cocos2d::CCArray*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(URLViewLayer, init, gd::string, cocos2d::CCArray*)
		}
	};
}
