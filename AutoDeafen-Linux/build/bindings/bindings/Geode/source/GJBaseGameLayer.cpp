...
auto GJBaseGameLayer::getRecordString(bool p0) -> decltype(getRecordString(p0)) {
	using FunctionType = decltype(getRecordString(p0))(*)(GJBaseGameLayer*, bool);
...
auto GJBaseGameLayer::resetRecord(int p0, bool p1) -> decltype(resetRecord(p0, p1)) {
	using FunctionType = decltype(resetRecord(p0, p1))(*)(GJBaseGameLayer*, int, bool);
