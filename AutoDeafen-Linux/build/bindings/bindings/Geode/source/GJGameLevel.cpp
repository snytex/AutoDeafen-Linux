...
auto GJGameLevel::saveNewScore(int value, int type, int p2, int p3, int p4, gd::string p5, bool p6) -> decltype(saveNewScore(value, type, p2, p3, p4, p5, p6)) {
	using FunctionType = decltype(saveNewScore(value, type, p2, p3, p4, p5, p6))(*)(GJGameLevel*, int, int, int, int, int, gd::string, bool);
	static auto func = wrapFunction<FunctionType>(base::get() + 0x16d230, tulip::hook::TulipConvention::Thiscall);
	return reinterpret_cast<FunctionType>(func)(this, value, type, p2, p3, p4, p5, p6);
}
