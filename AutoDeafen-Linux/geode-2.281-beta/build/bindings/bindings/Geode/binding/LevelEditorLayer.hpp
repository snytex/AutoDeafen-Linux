...
public:
     ...
     * @note[short] Android: Rebinded
     */
    void addTriggersWithGroupID(gd::unordered_set<int>& p0, cocos2d::CCArray* p1, gd::unordered_map<int, int>& p2, int p3);
     ...
     * @note[short] Android: Rebinded
     */
    void addTriggersWithTargetGroupID(gd::unordered_set<int>& p0, gd::unordered_set<int>& p1, cocos2d::CCArray* p2, gd::unordered_map<int, int>& p3, int p4);
