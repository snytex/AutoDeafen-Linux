...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCLayerMultiplex> : ModifyBase<ModifyDerive<Der, cocos2d::CCLayerMultiplex>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCLayer*, ...>::func(&cocos2d::CCLayerMultiplex::create)), Default, cocos2d::CCLayerMultiplex, create, cocos2d::CCLayer*, ...)
