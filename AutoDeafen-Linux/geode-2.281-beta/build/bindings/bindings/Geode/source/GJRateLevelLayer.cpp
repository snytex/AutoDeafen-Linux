...
auto GJRateLevelLayer::createStatPillar(int p0, int p1, int p2, cocos2d::ccColor3B p3, cocos2d::ccColor3B p4, cocos2d::CCPoint p5, gd::string p6) -> decltype(createStatPillar(p0, p1, p2, p3, p4, p5, p6)) {
	using FunctionType = decltype(createStatPillar(p0, p1, p2, p3, p4, p5, p6))(*)(GJRateLevelLayer*, int, int, int, cocos2d::ccColor3B, cocos2d::ccColor3B, cocos2d::CCPoint, gd::string);
